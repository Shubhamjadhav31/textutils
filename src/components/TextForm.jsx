...
export default function TextForm(props) {
  ...
  return (
    <>
<div className="container"style={{color:(props.mode==='dark'?'white':'#230653')}}>
    <h1 className='mb-4'>{props.heading}</h1>
    <div className="mb-3">
        <textarea className="form-control" value={text} onChange={handleOnChange} style={{backgroundColor:props.mode==='dark'?'#384385':'white', color: props.mode==='dark'?'white':'#230653'}} id="myBox" rows="8"></textarea>
     </div>
     ...
     <button disabled={text.length===0}  className="btn btn-info mx-1 my-1" onClick={handleExtraSpaces}>Remove Extra Spaces</button>
            ...
            <div className="container my-3"style={{color:(props.mode==='dark'?'white':'#230653')}}> 
