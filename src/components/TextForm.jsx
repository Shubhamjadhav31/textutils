...
<div className="container"style={{color:(props.mode==='dark'?'white':'#230653')}}>
    <h1>{props.heading}</h1>
    <div className="mb-3">
        <textarea className="form-control" value={text} onChange={handleOnChange} style={{backgroundColor:props.mode==='dark'?'grey':'white', color: props.mode==='dark'?'white':'#230653'}} id="myBox" rows="8"></textarea>
     </div>
